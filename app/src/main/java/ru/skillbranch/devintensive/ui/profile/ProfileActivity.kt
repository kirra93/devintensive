...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun showCurrentMode(isEdit: Boolean) {
        ...
        with (btn_edit) {
            ...
            val icon = if (isEdit) {
                ...
                resources.getDrawable(R.drawable.ic_settings_black_24dp, theme)
            }
    ...
    private fun updateUI(profile: Profile) {
        profile.toMap().also {
            Log.d("M_ProfileActifity", it.toString())
    ...
    private fun saveProfileInfo() {
        Log.d("M_Profile_activity", "saveProfileInfo")
        Profile(
